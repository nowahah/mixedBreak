...
# 
# ## * mixed.break1
# ## Destined to become a function only for fitting unconstrained model w\
# ## 1-3 breakpoints only (and mixed.break be a wrapper around plateau / 
# ## non-plateau estimation functions)
# ##' TODO - [at]export
