...
source("test/simStudy/trueTraj.R")
source("test/simStudy/noiseTraj.R")
source("test/simStudy/normalize.R")
source("R/confint.R")
source("R/print.R")
source("R/plot.R")
...
# write_xlsx(estimates.10, "data/estimates_10-lastrun.xlsx")
...
# # last 2 should are identical due to seed management